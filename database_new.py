...
class Database:
    ...
    def add_builty(self, builty_number, date, rake_point_name, account_id, warehouse_id,
        ...
        try:
            cursor.execute('''
                INSERT INTO builty (builty_number, date, rake_point_name, account_id, warehouse_id,
                                   truck_id, loading_point, unloading_point, goods_name, number_of_bags,
                                   quantity_mt, kg_per_bag, rate_per_mt, total_freight, lr_number,
                                   lr_index, created_by_role)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (builty_number, date, rake_point_name, account_id, warehouse_id, truck_id,
    ...
    def add_loading_slip(self, rake_code, slip_number, loading_point_name, destination,
                        account_id, quantity_bags, quantity_mt, truck_id, wagon_number, builty_id):
        ...
        try:
            ...
            ''', (rake_code, slip_number, loading_point_name, destination, account_id,
                  quantity_bags, quantity_mt, truck_id, wagon_number, builty_id))
